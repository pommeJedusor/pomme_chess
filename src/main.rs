...
impl ChessBoard {
    ...
    fn get_rook_moves(&self, index: u8, ma: &binary_mask::MainHashtables) -> u64 {
        ...
        //println!("rook");
        //binary_mask::print_mask(rook_moves & self.player ^ rook_moves);
        rook_moves & self.player ^ rook_moves
    }
    ...
    fn get_bishop_moves(&self, index: u8, ma: &binary_mask::MainHashtables) -> u64 {
        ...
        //println!("bishop");
        //binary_mask::print_mask(bishop_moves & self.player ^ bishop_moves);
        bishop_moves & self.player ^ bishop_moves
    }

    fn get_knight_moves(&self, index: u8, ma: &binary_mask::MainHashtables) -> u64 {
        let knight_moves = ma.knight_move_masks[index as usize];
        println!("knight");
        binary_mask::print_mask(knight_moves & self.player ^ knight_moves);
        knight_moves & self.player ^ knight_moves
    }
